...
plt.bar(np.arange(len(categories)), values1, color=colors1,  width=bar_width, label='Irregular')
plt.bar(np.arange(len(categories)), values2, color=colors3,  bottom=values1, width=bar_width, label='Regular')
...
plt.savefig('motivation2.pdf',bbox_inches='tight')
