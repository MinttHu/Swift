...
data_A = np.genfromtxt('result__spmm_f64_n32.txt', delimiter=' ')
data_B = np.genfromtxt('result_ASpT_spmm_f64_n32.txt', delimiter=' ')
data_C = np.genfromtxt('results_spmm_f32_32.txt', delimiter=' ')
...
plt.scatter(x_A_log, y_D_log, c='black', s=10, marker = 's',label='RoDe')
...
plt.savefig('timecompare_full_f64_n32_sum.png',bbox_inches='tight')
